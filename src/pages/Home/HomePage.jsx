...
import { getHomePagePictures } from "../../lib/requests";
    ...
    <div className="home-page">
      ...
      >
        {sliderItems.map((el, i) => {
          return <div style ={{backgroundImage:`url(${generalUrl}/${el.path})`, backgroundSize:"cover", backgroundRepeat:"no-repeat"}} key = {i}/>;
        })}
      </AutoplaySlider>
    </div>
  );
